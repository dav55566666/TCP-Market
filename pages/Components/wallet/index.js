...
import WalletLinkItem from "./walletlink/item"
...
const menu = (
  <Menu className="walletantd">
    <Menu.Item>
      <WalletLink>
        <WalletLinkItem linkhref={"wallet"} linkname={"Кошелек"} />
        <WalletLinkItem linkhref={""} linkname={"Операции"} />
        <WalletLinkItem linkhref={""} linkname={"Имущество"} />
      </WalletLink>
    </Menu.Item>
  </Menu>
);
                  ...
                  <div className="wallet-cont-info-rigth-top">
                    <div className="wallet-cont-info-rigth-top-balance">
                      ...
                      <div className="balance-box">
                        ...
                        <a>Контроль расходов <img src="/icons/go to.svg" /></a>
                      </div>
                      <Card>
